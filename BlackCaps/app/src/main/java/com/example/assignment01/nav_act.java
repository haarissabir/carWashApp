...
public class nav_act extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(this);
            if(savedInstanceState == null) {
                getSupportFragmentManager().beginTransaction().replace(R.id.container1, new welcome()).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.container1, new map_act()).commit();

        } else if (id == R.id.nav_manage) {
            getSupportFragmentManager().beginTransaction().replace(R.id.container1, new Profile()).commit();
